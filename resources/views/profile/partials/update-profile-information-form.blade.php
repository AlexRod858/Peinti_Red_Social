<section>
    <header>
        ...
        <p class="mt-1 text-sm text-gray-600">
            {{ __("Actualiza la información del perfil de la cuenta.") }}
        </p>
    </header>
    ...
    <form action="{{ route('actualizar_foto') }}" method="POST" enctype="multipart/form-data">
        ...
        <button type="submit" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 mt-4 rounded">Actualizar Foto</button>
    </form>
